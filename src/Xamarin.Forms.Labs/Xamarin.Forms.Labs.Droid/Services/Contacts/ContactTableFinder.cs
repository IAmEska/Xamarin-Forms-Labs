...
using Xamarin.Forms.Labs.Droid.Services.ContentQuery;
...
namespace Xamarin.Forms.Labs.Droid.Services.Contacts
{
    internal class ContactTableFinder
        : Xamarin.Forms.Labs.Droid.Services.ContentQuery.ExpressionVisitor, ITableFinder
    {
        ...
        public bool IsSupportedType(Type type)
        {
            ...
            || type == typeof(Phone)
            || type == typeof(Xamarin.Forms.Labs.Services.Contacts.Email)
            || type == typeof(Address)
            
            //TODO implement platfrom specific data
        ...
        public ContentResolverColumnMapping GetColumn(MemberInfo member)
        {
            ...
            if (member.DeclaringType == typeof(Xamarin.Forms.Labs.Services.Contacts.Email))
        ...
        private ContentResolverColumnMapping GetContactColumn(MemberInfo member)
        {
            switch (member.Name)
            {
                ...
                case "Emails":
                    return new ContentResolverColumnMapping((string)null, typeof(IEnumerable<Xamarin.Forms.Labs.Services.Contacts.Email>));
                case "Addresses":
        ...
        protected override Expression VisitMemberAccess(MemberExpression member)
        {
            ...
            if (this.table == null)
            {
                ...
                else if (member.Member.DeclaringType == typeof(Xamarin.Forms.Labs.Services.Contacts.Email))
