...
namespace Xamarin.Forms.Labs.Droid.Services.Contacts
{
    internal static class ContactHelper
    {
        ...
        internal static Xamarin.Forms.Labs.Services.Contacts.Email GetEmail(ICursor c, Resources resources)
        {
            Xamarin.Forms.Labs.Services.Contacts.Email e = new Xamarin.Forms.Labs.Services.Contacts.Email();
        ...
        {
            Xamarin.Forms.Labs.Services.Contacts.Organization o = new Xamarin.Forms.Labs.Services.Contacts.Organization();

            o.Name = c.GetString(OrganizationData.Company);
            o.JobDescription = c.GetString(OrganizationData.JobDescription);
            o.OfficeLocation = c.GetString(OrganizationData.OfficeLocation);
        ...
        internal static Xamarin.Forms.Labs.Services.Contacts.Email.EmailType ToEmailType(this EmailDataKind emailKind)
        {
            switch (emailKind)
            {
                case EmailDataKind.Home:
                    return Xamarin.Forms.Labs.Services.Contacts.Email.EmailType.Personal;
                case EmailDataKind.Work:
                    return Xamarin.Forms.Labs.Services.Contacts.Email.EmailType.Work;
                default:
                    return Xamarin.Forms.Labs.Services.Contacts.Email.EmailType.Other;
            }
        }

        internal static Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType ToPhoneType(this PhoneDataKind phoneKind)
        {
            switch (phoneKind)
            {
                case PhoneDataKind.Home:
                    return Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType.Home;
                case PhoneDataKind.Mobile:
                    return Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType.Mobile;
                case PhoneDataKind.FaxHome:
                    return Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType.HomeFax;
                case PhoneDataKind.Work:
                    return Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType.Work;
                case PhoneDataKind.FaxWork:
                    return Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType.WorkFax;
                case PhoneDataKind.Pager:
                case PhoneDataKind.WorkPager:
                    return Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType.Pager;
                default:
                    return Xamarin.Forms.Labs.Services.Contacts.Phone.PhoneType.Other;
            }
        }
